<template>
    <footer class="flex flex-col w-full">
        <div class="container mx-auto md:px-40 flex flex-row items-center justify-center  mx-auto my-10">
        ...
        <div class="w-full bg-gray-100 dark:bg-black dark:text-white border py-2 px-0">
            <div class="container mx-auto md:px-40 grid md:grid-cols-2 lg:grid-cols-4 gap-5 px-10">
        ...
        <p class="py-2 bg-black text-white text-center dark:text-black dark:bg-white">Copyright &copy; 2024 Nội Thất MOHO.</p>
    </footer>
</template>
<script>
