            ...
            <div class="container mx-auto md:px-40">
                ...
                <ul class="hidden lg:flex gap-5 text-sm">
                  ...
                  <div class="flex items-center gap-2">
                    <a @click="openLogin">
                      <VueIcon type="mdi" :path="mdiAccountOutline" size="28" class="cursor-pointer" />
                    </a>
                    <!-- Giỏ hàng -->
                    <div @click="openCart" class="relative cursor-pointer">
                      <VueIcon type="mdi" :path="mdiShoppingOutline" size="28" />
                      <span class="absolute -top-2 -right-2 w-4 h-4 rounded-full bg-orange-600 text-white text-xs flex items-center justify-center">{{ countCart }}</span>
                    </div>
                  </div>
                </div>
            </div>
    ...
    methods:{
        ...
        handleSmartScroll() {
            ...
            if (currentY > this.lastScrollY) {
                // Scroll xuống: throttle hiện sticky nav
                ...
                // Scroll lên: hiện nav thường ngay lập tức
                if (this.scrollTimeout) {
